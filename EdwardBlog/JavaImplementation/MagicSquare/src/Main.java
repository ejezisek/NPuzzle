...
public class Main {
	 ...
	 * @return
	 */
	public static List<SlidingSquare> solveSlidingSquare_BruteForce(SlidingSquare sq)
	{
		...
		while(!q.isEmpty())
		{
			...
			for(SlidingSquare.DIRECTION d : SlidingSquare.DIRECTION.values())
			{
				...
				if(!moved.isSolved())
				{
					...
					return Arrays.asList(moved.getRoute());
			}
		}
		return null;
	}
	 ...
	 * @return
	 */
	public static List<SlidingSquare> solveSlidingSquare_BFS(SlidingSquare sq)
	{
		...
		while(!q.isEmpty())
		{
			...
			for(SlidingSquare.DIRECTION d:SlidingSquare.DIRECTION.values())
			{
				...
				else
				{
					...
					System.out.println("Index: " + moved.getRoute().length);
					return;
				}
			}
