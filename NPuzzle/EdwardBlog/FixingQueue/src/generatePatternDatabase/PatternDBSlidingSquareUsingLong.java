...
public class PatternDBSlidingSquareUsingLong
{
	...
	public PatternDBSlidingSquareUsingLong(byte[] value, int integer, byte height, byte width)
	{
		this.squares=toLong(value);
	...
	public PatternDBSlidingSquareUsingLong(long value, int integer, byte height, byte width)
	{
		this.squares=value;
		this.numInRoute=(byte)integer;
		this.height=height;
